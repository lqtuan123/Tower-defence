...
enemy_images = {
  ...
  "elite": pg.image.load('assets/images/enemies/enemy_5.png').convert_alpha()
}
#buttons
...
pause_button = Button(c.SCREEN_WIDTH + 18, 230, pause_image, True)
restart_button = Button(310, 300, restart_image, True)
fast_forward_button = Button(c.SCREEN_WIDTH + 39, 300, fast_forward_image, False)
...
while run:
    ...
    if not game_paused:
        ...
        if game_over == False:
            ...
            # Update groups only if game is not paused
    ...
    if game_over == False:
        ...
        if level_started == False:
            ...
            # Spawn enemies if game is not paused
        ...
        # Turret placement and upgrade logic
    ...
    if game_paused:
        draw_text("PAUSED", large_font, "grey0", 350, 250)
